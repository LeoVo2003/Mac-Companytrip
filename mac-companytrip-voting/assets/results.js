(() => {
  ...
  function renderIdle() {
    setHeading("KẾT QUẢ VĂN NGHỆ", "Khoảnh khắc đang đến gần", "6 đội · 1 hải trình · 1 ngôi vị cao nhất", "Sẵn sàng công bố");
