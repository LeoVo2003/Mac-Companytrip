(() => {
  ...
  function shell(teams) {
    root.innerHTML = `<div class="mr-shell" data-stage="idle"><canvas class="mr-pyro" aria-hidden="true"></canvas><div class="mr-aurora" aria-hidden="true"><i></i><i></i><i></i></div><div class="mr-compass" aria-hidden="true"><svg viewBox="0 0 200 200" fill="none"><circle cx="100" cy="100" r="96" stroke="currentColor" stroke-width="0.6"/><circle cx="100" cy="100" r="86" stroke="currentColor" stroke-width="0.4" stroke-dasharray="1 7"/><text x="100" y="13" text-anchor="middle" fill="currentColor" font-size="8" font-weight="600">N</text><text x="190" y="103" text-anchor="middle" fill="currentColor" font-size="8" font-weight="600">E</text><text x="100" y="195" text-anchor="middle" fill="currentColor" font-size="8" font-weight="600">S</text><text x="10" y="103" text-anchor="middle" fill="currentColor" font-size="8" font-weight="600">W</text><path d="M100 20 L106 94 L100 100 L94 94 Z" stroke="currentColor" stroke-width="0.4"/><path d="M100 180 L94 106 L100 100 L106 106 Z" stroke="currentColor" stroke-width="0.4"/><path d="M180 100 L106 94 L100 100 L106 106 Z" stroke="currentColor" stroke-width="0.4"/><path d="M20 100 L94 106 L100 100 L94 94 Z" stroke="currentColor" stroke-width="0.4"/><g transform="rotate(45 100 100)"><path d="M100 48 L104 96 L100 100 L96 96 Z" stroke="currentColor" stroke-width="0.35"/><path d="M100 152 L96 104 L100 100 L104 104 Z" stroke="currentColor" stroke-width="0.35"/><path d="M152 100 L104 96 L100 100 L104 104 Z" stroke="currentColor" stroke-width="0.35"/><path d="M48 100 L96 104 L100 100 L96 96 Z" stroke="currentColor" stroke-width="0.35"/></g><g class="mr-needle"><path d="M100 30 L105 100 L100 106 L95 100 Z" fill="currentColor" fill-opacity="0.35" stroke="currentColor" stroke-width="0.5"/><path d="M100 170 L95 100 L100 94 L105 100 Z" stroke="currentColor" stroke-width="0.5"/><circle cx="100" cy="100" r="3.5" fill="currentColor"/></g></svg></div><header class="mr-header"><img src="${esc(logo)}" alt="MAC Marketing"><div class="mr-event"><span>company trip - One Direction</span><strong>KẾT QUẢ VĂN NGHỆ</strong></div><div class="mr-connection" role="status"><i></i><span>Đang đồng bộ</span></div></header><main><div class="mr-heading" aria-live="polite"><p>KẾT QUẢ VĂN NGHỆ</p><h1>Khoảnh khắc đang đến gần</h1><span></span></div><section class="mr-chart" aria-label="Biểu đồ điểm của 6 đội">${teams.map((team) => `<article class="mr-team" data-team-id="${team.id}" role="group" aria-label="Team số ${team.number} ${esc(team.name)}"><div class="mr-score"><span>—</span><small>ĐIỂM</small></div><div class="mr-column"><div class="mr-rank" hidden></div><div class="mr-bar"><span></span><i></i></div><div class="mr-base"></div></div><div class="mr-team-name"><b>#${team.number}</b><strong>${esc(team.name)}</strong></div></article>`).join("")}</section></main><footer class="mr-footer"><span class="mr-stage-copy">Sẵn sàng công bố</span><div><i></i><span>LIVE RESULT</span></div></footer></div>`;
  }
